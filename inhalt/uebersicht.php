    ...
    <body text="#000000" bgcolor="#444444" style="background-image:url('<?php echo $bildpfad?>/aufbau/14.gif'); background-attachment:fixed;" link="#000000" vlink="#000000" alink="#000000" leftmargin="0" rightmargin="0" topmargin="0" marginwidth="0" marginheight="0">
        <center>
            <table border="0" height="100%" cellspacing="0" cellpadding="0">
                <tr>
                    <td><center><a href="uebersicht_uebersicht.php?fu=1&uid=<?php echo $uid?>&sid=<?php echo $sid?>&sprache=<?php echo $_GET["sprache"]?>" target="rahmen12" onclick="self.focus();"><img src="<?php echo $bildpfad?>/menu/uebersicht.gif" width="75" height="75" border="0"><br><nobr><?php echo $lang['uebersicht']['uebersicht']?></nobr></a></center></td>
                    <td><center><a href="uebersicht_imperien.php?fu=1&uid=<?php echo $uid?>&sid=<?php echo $sid?>&sprache=<?php echo $_GET["sprache"]?>" target="rahmen12" onclick="self.focus();"><img src="<?php echo $bildpfad?>/menu/imperien.gif" width="75" height="75" border="0"><br><nobr><?php echo $lang['uebersicht']['imperien']?></nobr></a></center></td>
                    <?php if ($spieler_raus==0) { ?>
                        <td><center><a href="uebersicht_neuigkeiten.php?fu=1&uid=<?php echo $uid?>&sid=<?php echo $sid?>&sprache=<?php echo $_GET["sprache"]?>" target="rahmen12" onclick="self.focus();"><img src="<?php echo $bildpfad?>/menu/neuigkeiten.gif" width="75" height="75" border="0"><br><nobr><?php echo $lang['uebersicht']['neuigkeiten']?></nobr></a></center></td>
